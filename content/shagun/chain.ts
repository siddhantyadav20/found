...
export const chain: readonly Link[] = [
  ...
  },
  {
    ...
    unnamed: "A friend of Sameer's got a car to the service gate, and it left without Dilip.",
    owner: "Nitin",
    kind: "spine",
  },
  {
    ...
    unnamed: "At 1:52 Sameer told the friend who'd sent the car that Dilip had gone for treatment. He knew he hadn't.",
    owner: "Sameer",
    kind: "deep",
