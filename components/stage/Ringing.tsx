...
/* ===========================================================================
   ...
   Some calls insist. Declining one that insists only makes it ring again,
   which is exactly what the real crime does to real people.
...
export default function Ringing({
  ...
  return (
    <div className={styles.screen}>
      <p className={styles.label}>{answered ? "Call in progress" : "Incoming call"}</p>
