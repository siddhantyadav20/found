...
/* The found phone's app icons, drawn to sit as close to current iOS as a drawing can: the
   ...
   what they are (a bubble, a lens), never their logo; and any app that is
   part of a chapter's crime is ours outright. */
...
const FULL: ReadonlySet<AppId> = new Set<AppId>(["notes", "photos", "safari"]);
